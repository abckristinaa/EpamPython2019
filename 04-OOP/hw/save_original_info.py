...
def save_attribute(func):
    def inner(wrapped):
        """ Function-wrapper which save some atributes of an original function.

        Sets to wrapped function new atribute:  __original_func = func.
        Takes __name__ and __doc__ atributes from an original function.
        """
